...
exports.Role = require('./lib/auth/role').Role;
exports.SessionsService = require('./lib/auth/sessions.service').SessionsService;
exports.SessionObjectsService = require('./lib/auth/session-objects.service').SessionObjectsService;
